(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('shallowequal'), require('@babel/core')) :
    typeof define === 'function' && define.amd ? define(['exports', 'shallowequal', '@babel/core'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.limbo = {}, global._shallowEqual, global.babel));
}(this, (function (exports, _shallowEqual, babel) { 'use strict';
    ...
    const resolveParsedNode = (node) => {
        ...
        if(type === 'node') return createElement(tag, attributes, ...children)
    };
    ...
    const transformJsx2Vd = (template) => {
        const ret = babel__default['default'].transformSync(template, {
            plugins: [[
        ...
        return new Function('h', code)(createElement)
    };
    ...
    unwrapExports(error);
    var error_1 = error.errors;
    var error_2 = error.Errors;
    ...
    function parse(source) {
        ...
        const readComment = () => {
            ...
            if (!comment) {
                (0, error.errors)(error.Errors.CommentNotMatchEnd, { line, column });
            }
            return comment;
        };
        const readTag = () => {
            ...
            const flushAttr = () => {
                ...
                if (readyResolveValue && !valueStart && !valueEnd) {
                    const { line, column } = debugMap[attrStart];
                    (0, error.errors)(error.Errors.LackPropertyValue, { attr: name, line, column });
                }
                let value;
                if (!valueStart)
                    value = true;
            ...
            while (true) {
                char = readNext();
                if (index === source.length)
                    (0, error.errors)(error.Errors.ResolveOverflowLength);
                if (char !== '>' && char !== '/' && !resolveTagName && !attrStart && /\S/.test(char))
                    attrStart = index;
                // resolve end
                if (char === '>') {
            ...
            while (index < source.length) {
                ...
                if (char === '<') {
                    ...
                    // close
                        ...
                        if (tag !== parent.tag) {
                            (0, error.errors)(error.Errors.UnexpectedTagClose, { line, column, tag, correct: parent.tag });
                        }
                        return;
                    }
                    const node = readTag();
    ...
    exports.transformJsx2Vd = transformJsx2Vd;
